...
import 'package:project_master_template/app/core/theme/static_colors.dart';
...
MaterialColor secondaryColor = MaterialColor(AppColors.secondary500.toARGB32(), const <int, Color>{
...
MaterialColor neutralColor = MaterialColor(AppColors.neutral500.toARGB32(), const <int, Color>{
...
MaterialColor whiteColor = MaterialColor(AppColors.white500.toARGB32(), const <int, Color>{
...
MaterialColor blackColor = MaterialColor(AppColors.black500.toARGB32(), const <int, Color>{
...
MaterialColor errorColor = MaterialColor(AppColors.error500.toARGB32(), const <int, Color>{
...
MaterialColor positiveColor = MaterialColor(AppColors.positive500.toARGB32(), const <int, Color>{
