...
void main() {
  group('AppTheme', () {
    testWidgets('should use Playfair Display for headlineLarge', (tester) async {
      ...
      expect(theme.textTheme.headlineLarge?.fontFamily, contains('Playfair'));
    ...
    testWidgets('should use Inter for bodyLarge', (tester) async {
      await tester.pumpWidget(MaterialApp(theme: AppTheme.darkTheme, home: const Scaffold(body: Text('Test Body'))));
